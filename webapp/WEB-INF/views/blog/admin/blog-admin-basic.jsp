			...
			<div id="admin-content">
				<form action="${pageContext.request.contextPath}/${id}/admin/basic/upload" method="post" enctype="multipart/form-data">
					<table id="admin-basic">
						...
						<tr>
							<td>
								<label for="textTitle">블로그 제목</label>
							</td>
							<td>
								<input id="textTitle" type="text" name="blogTitle" value="${bMap.blogVo.blogTitle }">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td class="text-left">
								...
								<c:if test="${not empty bMap.blogVo.logoFile }">
									<img src="${pageContext.request.contextPath}/upload/${bMap.blogVo.logoFile }">
								</c:if>
							</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>
								<input id="textLogo" type="file" name="file">
							</td>
						</tr>
					</table>
					<div id="btnArea">
